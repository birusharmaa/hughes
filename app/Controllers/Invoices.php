...
class Invoices extends Security_Controller {
    ...
    function modal_form() {
        ...
        //check if estimate_id/order_id/proposal_id posted. if found, generate related information
        ...
        if ($estimate_id || $order_id || $proposal_id) {
            $info = null;
            if ($estimate_id) {
    ...
    function save() {
        ...
        if ($invoice_id) {
            ...
            //submitted copy_items_from_estimate/copy_items_from_order/copy_items_from_proposal? copy all items from the associated one
            ...
            $this->_copy_related_items_to_invoice($copy_items_from_estimate, $copy_items_from_proposal, $copy_items_from_order, $invoice_id);
    ...
    private function _copy_related_items_to_invoice($copy_items_from_estimate, $copy_items_from_proposal, $copy_items_from_order, $invoice_id) {
        if (!($copy_items_from_estimate || $copy_items_from_proposal || $copy_items_from_order)) {
            return false;
        }
