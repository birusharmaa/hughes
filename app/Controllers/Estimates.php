...
class Estimates extends Security_Controller {
    ...
    function modal_form() {
        ...
        //check if proposal_id/order_id posted. if found, generate related information
    ...
    function save() {
        ...
        if ($estimate_id) {
            ...
            //submitted copy_items_from_proposal/copy_items_from_order? copy all items from the associated one
            ...
            $this->_copy_related_items_to_estimate($copy_items_from_proposal, $copy_items_from_order, $estimate_id);
    ...
    private function _copy_related_items_to_estimate($copy_items_from_proposal, $copy_items_from_order, $estimate_id) {
        if (!($copy_items_from_proposal || $copy_items_from_order)) {
            return false;
        }
    ...
    function comment_modal_form() {
        ...
        return $this->template->view('estimates/comment_modal_form', $view_data);
    }
