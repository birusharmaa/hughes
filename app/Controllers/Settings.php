...
class Settings extends Security_Controller {
    ...
    function company() {
        $view_data["page_title"] = "Settings";
        return $this->template->rander("settings/company",$view_data);
    }
    ...
    function email() {
        $view_data["page_title"] = "Settings";
        return $this->template->rander("settings/email",$view_data);
    }
    ...
    function save_estimate_settings() {
        $settings = array("estimate_logo", "estimate_prefix", "estimate_color", "estimate_footer", "send_estimate_bcc_to", "initial_number_of_the_estimate", "create_new_projects_automatically_when_estimates_gets_accepted", "enable_comments_on_estimates", "show_most_recent_estimate_comments_at_the_top");
        $reload_page = false;
    ...
    function save_proposal_settings() {
        $settings = array("proposal_prefix", "proposal_color", "send_proposal_bcc_to", "initial_number_of_the_proposal", "add_signature_option_on_accepting_proposal", "default_template");
        $reload_page = false;
