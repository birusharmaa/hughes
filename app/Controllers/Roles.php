...
class Roles extends Security_Controller {
    ...
    function index() {
        ...
        return $this->template->rander("roles/index",$view_data);
    }
    ...
    function permissions($role_id) {
        if ($role_id) {
            ...
            $view_data['transport'] = get_array_value($permissions, "transport");
    ...
    function save_permissions() {
        ...
        $transport = $this->request->getPost('transport_permission');
    ...
    function user_roles() {
        $view_data["page_title"] = "Settings";
        return $this->template->rander("roles/user_roles/index",$view_data);
    }
