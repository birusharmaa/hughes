...
if (!function_exists('prepare_allowed_members_array')) {
    ...
    if (!function_exists('get_lead_source_by_id')) {

        function get_lead_source_by_id($id) {
            $ci = new App_Controller();
            $invoice_info = $ci->Lead_source_model->get_lead_source_by_id($id);
            return $invoice_info;
        }
    
    }

    if (!function_exists('get_industry_by_id')) {

        function get_industry_by_id($id) {
            $ci = new App_Controller();
            $invoice_info = $ci->Lead_industry_model->get_industry_by_id($id);
            return $invoice_info;
        }
    
    }

    if (!function_exists('get_total_leads_count')) {
