...
<div class="row">
    <?php //print_r($model_info);exit; 
    ?>
    <input type="hidden" value=<?php echo $model_info->lead_status_id; ?> name="lead_status_id">
    <div class="col-md-6">
...
<div class="form-group bg-danger">
    <div class="row">
        <div class="col-md-12">
            <label for="lead_status_id"><?php //echo app_lang('status'); 
                                        ?></label>
            <?php
