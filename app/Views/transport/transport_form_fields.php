...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                    <label for="transport_company_name">
                        <?php echo app_lang('transport_company_name') . "<span style='color:red!important;'>*</span>";  ?></label>
                    </label>
                    <?php
                    echo form_input(array(
                        "id" => "transport_company_name",
                        "name" => "transport_company_name",
                        "value" => $trans->transport_comp_name,
                        "class" => "form-control",
                        "placeholder" => app_lang('transport_company_name'),
                        "autocomplete" => 'off',
                        "autofocus" => true,
                        "data-rule-required" => true,
                        "data-msg-required" => app_lang("field_required"),
