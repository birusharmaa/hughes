    ...
    <div class="sidebar-scroll">
        <ul id="sidebar-menu" class="sidebar-menu">
            ...
            <li class="<?php echo $active_class . " " . $expend_class . " " . $submenu_open_class . " "; ?> main">
                <a <?php echo $target; ?>
                    href="<?php echo isset($main_menu['is_custom_menu_item']) ? $main_menu['url'] : get_uri($main_menu['url']); ?>">
                    <i data-feather="<?php echo ($main_menu['class']); ?>" class="icon"></i>
                    <span
                        class="menu-text <?php echo isset($main_menu['custom_class']) ? $main_menu['custom_class'] : ""; ?>"><?php echo isset($main_menu['is_custom_menu_item']) ? $main_menu['name'] : app_lang($main_menu['name']); ?></span>
                    <?php
                            if ($badge) {
                        ...
                        if ($submenu) {
                            ...
                            foreach ($submenu as $s_menu) {
                                if (isset($s_menu['name'])) {
                                    ...
                                    ?>
            <li>
                <a <?php echo $sub_menu_target; ?>
                    href="<?php echo isset($s_menu['is_custom_menu_item']) ? $s_menu['url'] : get_uri($s_menu['url']); ?>">
