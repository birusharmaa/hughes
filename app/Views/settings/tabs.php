...
//restricted settings
// $settings_menu["setup"][] = array("name" => "product_literature", "url" => "Product_Literature");
// $settings_menu["setup"][] = array("name" => "add_subcategory", "url" => "Sub_category");
// $settings_menu["setup"][] = array("name" => "add_sub_subcategory", "url" => "Sub_subcategory");
...
if (get_setting("module_proposal") == "1") {
    $settings_menu["setup"][] = array("name" => "proposals", "url" => "settings/proposals");
}
...
<ul class="nav nav-tabs vertical settings d-block" role="tablist">
    ...
    <div class="clearfix settings-anchor <?php echo $collapsed_class; ?>" data-bs-toggle="collapse"
        data-bs-target="#settings-tab-<?php echo $key; ?>">
