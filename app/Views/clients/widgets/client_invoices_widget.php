...
if ($widget_type == "has_unpaid_invoices") {
    $card = "bg-orange";
    $widget_title = app_lang("customers_has_unpaid_invoices");
    $link = "has_unpaid_invoices";
} else if ($widget_type == "has_partially_paid_invoices") {
    $card = "bg-primary";
    $widget_title = app_lang("customers_has_partially_paid_invoices");
    $link = "has_partially_paid_invoices";
} else if ($widget_type == "has_overdue_invoices") {
    $card = "bg-danger";
    $widget_title = app_lang("customers_has_overdue_invoices");
...
<a class="client-widget-link" data-filter="<?php echo $link; ?>"
    href="<?php echo get_uri("clients/index/clients_list#$link"); ?>">
    <div class="card">
        <div class="card-body p20">
            ...
            <div class="clearfix">
                <span
                    class="text-off float-start mt-3 text-default"><?php echo $progress . "% " . app_lang("of_total_customers"); ?></span>
                <h1 class="float-end m0 text-default"><?php echo $total; ?></h1>
            </div>
            <div class="progress mt5" style="height: 6px;" title='<?php echo $progress; ?>%'>
                <div class="progress-bar <?php echo $card; ?>" role="progressbar"
