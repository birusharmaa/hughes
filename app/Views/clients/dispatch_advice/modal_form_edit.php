...
<?php echo form_open(get_uri("DispatchAdvice/save_item"), array("id" => "DispatchAdvice-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <?php echo view("clients/dispatch_advice/edit_dispatch_filed"); ?>
    </div>
</div>
