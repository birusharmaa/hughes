...
class Orders_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $order_staus = get_array_value($options, "order_staus");
        if ($order_staus) {
            $where .= " AND $orders_table.order_staus='$order_staus'";
        }
        ...
        LEFT JOIN $order_status_table ON $orders_table.order_staus = $order_status_table.id 
